...
const INLINE_OUT = path.join(__dirname, 'foz-hero-inline.cjs');
const WIDTH = 400;
const QUALITY = 78;
...
async function main() {
  ...
  await fs.promises.writeFile(
    INLINE_OUT,
    '/** Generated by npm run optimize:foz-hero — do not edit */\n' +
      'module.exports = { FOZ_HERO_DATA_URI: ' + JSON.stringify(dataUri) + ' };\n'
  );

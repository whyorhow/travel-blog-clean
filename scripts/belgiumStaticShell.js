...
const SHELL_STYLES = `<style>
  ...
  #belgium-static-hero .belgium-static-hero-title{position:absolute;left:0;right:0;bottom:6%;z-index:2;margin:0;text-align:center;font:700 2.25rem Georgia,"Times New Roman",serif;color:#B8860B;text-shadow:0 2px 12px rgba(0,0,0,.55);pointer-events:none}

...
function logoImg(assetPrefix) {
  ...
  return (
    `<img src="${base}/LogoV6-800.webp" ` +
    `srcset="${base}/LogoV6-800.webp 800w, ${base}/LogoV6-1200.webp 1200w" ` +
    'sizes="(max-width:768px) 95vw, 56rem" alt="Nomad Scribbles" width="1200" height="171" ' +
...
const SHELL_STYLES = `<style>
  ...
  .home-hero{display:flex;flex-direction:column;align-items:center;justify-content:flex-start;text-align:center;padding:2rem 1rem 1.5rem;box-sizing:border-box;width:100%;flex:0 0 auto}

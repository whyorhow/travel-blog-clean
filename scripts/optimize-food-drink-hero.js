...
const INLINE_OUT = path.join(__dirname, 'food-drink-hero-inline.cjs');
const WIDTH = 400;
const QUALITY = 78;
...
async function main() {
  ...
  await fs.promises.writeFile(
    INLINE_OUT,
    '/** Generated by npm run optimize:food-drink-hero — do not edit */\n' +
      'module.exports = { FOOD_DRINK_HERO_DATA_URI: ' + JSON.stringify(dataUri) + ' };\n'
  );

...
const PHASE2_PAGES = [
  ...
  },
  {
    ...
    heroId: 'Greece/Athens/Athens-backup',
    resolvePublicId: 'Greece/Athens/Athens-backup',
    title: 'Athens',
    alt: 'Athens',
  ...
  },
  {
    ...
    heroId: 'Belgium/Antwerp/antwerp-backup',
    resolvePublicId: 'Belgium/Antwerp/antwerp-backup',
    title: 'Antwerp',
    alt: 'Antwerp',
  ...
  },
  {
    ...
    heroId: 'Hungary/Budapest/Budapest-backup',
    resolvePublicId: 'Hungary/Budapest/Budapest-backup',
    title: 'Budapest',
    alt: 'Budapest',
...
const PHASE3_PAGES = [
  ...
  },
  {
    ...
    heroId: 'Greece/Athens/Small/Acropolis Hill',
    resolvePublicId: 'Greece/Athens/Small/Acropolis Hill',
    title: 'Greece',

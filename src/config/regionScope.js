...
const REGION_SCOPE = {
  ...
  "/hungary": {
    ...
    hubNote:
      "Hungary starts with Budapest — the rest of the country is still to come.",
  },
  ...
  "/portugal": {
    ...
    regionLinks: [{ path: "/portugal/lisbon", label: "Lisbon" }],

    mapHint: "Lisbon so far",

    hubNote: "Portugal on the site begins in Lisbon. More routes may follow.",
  },

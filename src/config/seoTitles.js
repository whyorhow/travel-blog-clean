/**
 * Editorial SEO titles (P1) — "Stories from…" not "Travel Guide".
 * Used by staticRouteMeta (build-time head) and page-level <SEO />.
 */
const SEO_TITLES = {
  ...
  "/brazil/saopaulo/galleries":
    "Stories from São Paulo Galleries: MASP, Pinacoteca & Museums",
  "/brazil/saopaulo/carnival":
    "Stories from São Paulo Carnival: Blocos, Sambódromo & Street Celebrations",
  ...
  "/united-states/tennessee/memphis":
    "Stories from Memphis: Blues, Beale Street & Mississippi River",
  "/united-states/tennessee/nashville":
    "Stories from Nashville: Music City, Broadway & Songwriting Culture",
};

module.exports = { SEO_TITLES };

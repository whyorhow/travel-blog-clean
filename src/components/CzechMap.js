...
import czechMap from "../assets/images/Czech-Map.webp";
...
/** Invisible tap/click target — larger than the visible pin for easier clicking. */
const HIT_RADIUS = VIEWBOX_WIDTH * 0.05;

const CzechMap = ({ markers = [], onHoverMarker = null, hoveredId: externalHoveredId = null }) => {
  ...
  return (
    <div className="relative w-full h-full aspect-[4/3]">
      ...
      >
        <image href={czechMap} x="0" y="0" width="400" height="300" />

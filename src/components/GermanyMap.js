...
import GermanyMapImage from "../assets/images/Germany-Map.webp";
...
const GermanyMap = ({ markers = [], onHoverMarker = null, hoveredId: externalHoveredId = null }) => {
  ...
  return (
    <div className="relative w-full h-full aspect-[4/3]">
      ...
      >
        <image href={GermanyMapImage} x="0" y="0" width="400" height="300" />

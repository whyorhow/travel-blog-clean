    ...
    return (
        <div className="min-h-screen bg-[#451a03] text-stone-100 font-serif selection:bg-[#eeda8d] selection:text-[#451a03]">
            ...
            <div className="relative h-[90vh] w-full overflow-hidden flex items-center justify-center">
                ...
                >
                    <img
                        src={cloudFullSrc(getImage("salvador1"))}
            ...
            <main className="px-2 py-2 max-w-screen-xl mx-auto space-y-12 flex flex-col items-center pb-24 mt-24">
                ...
                <div className="w-full flex flex-col items-center justify-center gap-6 mt-20 mb-12 relative z-20 px-4">
                    <Link to="/brazil" className="flex flex-row items-center justify-center bg-[#451a03]/20 border-2 border-[#eeda8d] text-[#eeda8d] backdrop-blur-md rounded-xl py-3 px-4 text-center hover:bg-[#451a03]/30 hover:text-[#eeda8d] transition duration-300 text-sm font-medium uppercase tracking-wide shadow-lg w-[240px]">
                        <span className="text-lg mr-2">←</span>
                        <span className="text-sm font-medium">Return To Brazil</span>
                    </Link>
                    <Link to="/brazil/pantanal" className="flex flex-row items-center justify-center bg-[#451a03]/20 border-2 border-[#eeda8d] text-[#eeda8d] backdrop-blur-md rounded-xl py-3 px-4 text-center hover:bg-[#451a03]/30 hover:text-[#eeda8d] transition duration-300 text-sm font-medium uppercase tracking-wide shadow-lg w-[240px]">
                        <span className="text-sm font-medium">Next: The Pantanal</span>

...
export default function Murals({ openLightbox }) {
  ...
  // Get Murals images from artImages
  const muralImages = artImages.filter(img => img.category === "Murals");
  const getImage = (id) => muralImages.find(i => i.id === id);
    ...
    <div className="min-h-screen pb-16 transition-colors duration-500" style={{ backgroundColor: expandedCardBg || "#f5f5f4" }}>
      ...
      <div className="relative w-full overflow-hidden">
        ...
        <div className="w-full flex flex-col items-center gap-6 mt-12 mb-12 relative z-20 px-4">
          <Link
            to="/brazil/saopaulo"
            className="flex flex-row items-center justify-center bg-[#e8d5ce]/30 border-2 border-[#2e1065] text-[#2e1065] backdrop-blur-md rounded-xl py-3 px-4 text-center hover:bg-[#e8d5ce]/40 hover:text-[#2e1065] transition duration-300 text-sm font-medium uppercase tracking-wide shadow-lg w-[240px]"
          >
          ...
          <Link
            ...
            className="flex flex-row items-center justify-center bg-[#e8d5ce]/30 border-2 border-[#2e1065] text-[#2e1065] backdrop-blur-md rounded-xl py-3 px-4 text-center hover:bg-[#e8d5ce]/40 hover:text-[#2e1065] transition duration-300 text-sm font-medium uppercase tracking-wide shadow-lg w-[240px]"
          >
            <span className="text-sm font-medium">Next: Santos</span>

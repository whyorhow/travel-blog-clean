        ...
        <div className="transition-colors duration-500" style={pageBackgroundStyle}>
            ...
            <main className="px-2 py-2 max-w-screen-xl mx-auto space-y-12 flex flex-col items-center pb-24">
                ...
                <div className="w-full flex flex-col items-center gap-6 mt-20 mb-12 relative z-20 px-4">
                    <Link to="/brazil" className="flex flex-row items-center justify-center bg-[#9c6644]/20 border-2 border-[#9c6644] text-[#9c6644] backdrop-blur-md rounded-xl py-3 px-4 text-center hover:bg-[#9c6644]/30 hover:text-[#9c6644] transition duration-300 text-sm font-medium uppercase tracking-wide shadow-lg w-[240px]">
                        <span className="text-lg mr-2">←</span>
                        <span className="text-sm font-medium">Return To Brazil</span>
                    </Link>
                    <Link to="/brazil/florianopolis" className="flex flex-row items-center justify-center bg-[#9c6644]/20 border-2 border-[#9c6644] text-[#9c6644] backdrop-blur-md rounded-xl py-3 px-4 text-center hover:bg-[#9c6644]/30 hover:text-[#9c6644] transition duration-300 text-sm font-medium uppercase tracking-wide shadow-lg w-[240px]">
